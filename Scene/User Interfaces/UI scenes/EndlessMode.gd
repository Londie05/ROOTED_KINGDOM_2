...
func _ready() -> void:
	...
	daily_highest_label.text = "Today's Highest Round: " + str(Global.daily_highest_round)
	daily_rewards_label.text = "Rewards Earned Today: " + str(Global.daily_rewards_earned) + " Gems"
...
func update_reset_timer():
	...
	var hours_left = 23 - current_time["hour"]
